...
const MobileEdit = (props) => {
	...
	const newInitialValues = Object.assign(initialValues, {
		...
		storage: currentMobile && Object.keys(currentMobile).length > 0 ? currentMobile.storage : '',
		battery: currentMobile && Object.keys(currentMobile).length > 0 ? currentMobile.battery : '',
		stock: currentMobile && Object.keys(currentMobile).length > 0 ? currentMobile.stock : '',
		price: currentMobile && Object.keys(currentMobile).length > 0 ? currentMobile.price : '',
		status: currentMobile && Object.keys(currentMobile).length > 0 ? selectStatus(currentMobile.status) : '',
	});
	...
	const handleSubmitEvent = (values, actions) => {
		let post_data = {
			...
			reference_num: currentMobile && Object.keys(currentMobile).length > 0 ? currentMobile.reference_num : '',
			added_date: currentMobile && Object.keys(currentMobile).length > 0 ? currentMobile.added_date : '',
	...
	return (
		<Modal className="requestCallModal" show={mobileEditModal} onHide={() => setMobileEditModal(false)} backdrop="static" centered>
